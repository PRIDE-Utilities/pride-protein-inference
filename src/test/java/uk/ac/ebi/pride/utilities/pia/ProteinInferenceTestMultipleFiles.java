...
public class ProteinInferenceTestMultipleFiles {
	...
	public void testProteinGroup() throws Exception {
		...
		//
        URL mascotFile = ProteinInferenceTestMultipleFiles.class.getClassLoader().getResource("55merge_mascot_full.mzid");
        URL omssaFile  = ProteinInferenceTestMultipleFiles.class.getClassLoader().getResource("55merge_omssa.mzid");
		piaModeller.addFile(mascotFile.getFile());
		piaModeller.addFile(omssaFile.getFile());
